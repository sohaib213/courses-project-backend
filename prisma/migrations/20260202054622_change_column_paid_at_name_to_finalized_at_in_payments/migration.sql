/*
  ...
  - You are about to drop the column `stripe_payment_session_id` on the `payments` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "payments_stripe_payment_session_id_key";

-- AlterTable
ALTER TABLE "payments" DROP COLUMN "paid_at",
DROP COLUMN "stripe_payment_session_id",
